...
import { ProductListingTypeOrmReposiotory } from "../src/modules/products/infra/repositories/product-listing-tyoerm.repository.js";
...
describe("ProductListingTypeOrmRepository", () => {
  it("deve criar e salvar um anúncio", async () => {
    ...
    const productListingRepository =
      new ProductListingTypeOrmReposiotory(repository as any);
